...
if (isset($_GET['start'])) {
    ...
    if (isset($_GET['cari'])) {
        $sql = "select
                        ...
                        a.id as idd 
                    from
                        deposit a left join ortu b on b.id = a.id_ortu left join siswa c on c.id = b.id_siswa 
    ...
    if (isset($_GET['cari'])) {
        ...
        $sql = "select count(a.id) as jml from deposit a where a.status IN ($_GET[status])";
    }
