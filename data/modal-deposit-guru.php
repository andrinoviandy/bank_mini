...
<div class="form-group">
    ...
    <select name="id_guru" id="id_guru" required class="form-control select2" style="width:100%">
        <option value="">...</option>
        <?php
        $query_teknisi = mysqli_query($koneksi_kantin, "select a.id, a.kode, a.nama from guru a order by a.nama ASC");
        while ($data_t = mysqli_fetch_array($query_teknisi)) {
        ?>
            <option value="<?php echo $data_t['id']; ?>"><?php echo $data_t['kode'] . " - " . $data_t['nama']; ?></option>
        <?php } ?>
    </select>
</div>
<!-- <div class="form-group">
